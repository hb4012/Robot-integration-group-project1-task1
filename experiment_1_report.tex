...
The experiment is organized as a GitHub repository. Table~\ref{tab:files} lists the submitted contents. The complete project is available at \url{https://github.com/hb4012/Robot-integration-group-project1-task1}.

\begin{center}
\includegraphics[width=\columnwidth]{report_assets/github_commit_history.png}
\par\smallskip
\footnotesize Figure 5. GitHub commit history of the submitted project.
\end{center}
